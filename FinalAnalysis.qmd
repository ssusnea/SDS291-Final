...
## Model 1: Math
From the model predicting a school's average 2018 Algebra 2 Regents score, three statistically significant variables emerge as predictors of math test scores for a school.

One key variable mentioned in our initial hypothesis, teacher experience, was found statistically significant, which is positively associated with the schools' average math scores. However, the school's supportive environment, the other variable mentioned in our initial hypothesis, did not exhibit statistical significance in this model. We failed to provide evidence for an association between the school's supportive environment and math scores. Nevertheless, the coefficients for the control variables "chronic absence" and "economic need" are even more statistically significant (with even smaller p-values) than our key variables. Both economic need and chronic absence have a negative association with math scores (see @fig-plot1). 
...
## Model 2: English
For our model predicting a school's average 2018 English Regents score, non of our key variables (teacher experience and school's supportive environment) are statistically significant, so our initial hypothesis that average English test scores have a relationship with teacher experience as well as a school's supportive environment was not supported by this model. However, three of our control variables (chronic absenteeism, economic need, and rigorous instruction) were statistically significant. Both chronic absenteeism and economic need have a negative relationship with a school's average score for the 2018 English Regents (see @fig-plot2) while rigorous instruction has a positive relationship.
